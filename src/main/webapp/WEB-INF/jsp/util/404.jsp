...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="${ctx }/web/css/404.css">
    ...
    <script type="text/javascript" async="" src="${ctx }/web/js/util/ga.js"></script><script type="text/javascript">
...
<body>
    <div id="error">
      <a href="http://locahost:8080/user/welcome">
        <img src="/web/images/404.png" alt="404 page not found" id="error404-image">
      </a>
    </div>
